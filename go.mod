...
require (
	...
	github.com/decisiveai/opentelemetry-operator v0.113.2
...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20250806174037-6563d0ec3ca8 // indirect
	...
	github.com/openshift/api v0.0.0-20250806153419-7605f9b58fee // indirect
