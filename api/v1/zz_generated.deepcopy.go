...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FilterProcessorConfig) DeepCopyInto(out *FilterProcessorConfig) {
	*out = *in
	if in.ErrorMode != nil {
		in, out := &in.ErrorMode, &out.ErrorMode
		*out = new(ottl.ErrorMode)
		**out = **in
	}
	if in.Metrics != nil {
	...
	if in.Traces != nil {
		...
		*out = new(TraceFilters)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FilterProcessorConfig.
func (in *FilterProcessorConfig) DeepCopy() *FilterProcessorConfig {
	if in == nil {
		return nil
	}
	out := new(FilterProcessorConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetricFilters) DeepCopyInto(out *MetricFilters) {
	*out = *in
	...
	if in.DataPointConditions != nil {
		in, out := &in.DataPointConditions, &out.DataPointConditions
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
func (in *Observer) DeepCopyInto(out *Observer) {
	*out = *in
	...
	if in.OtelWatcherConfig != nil {
		in, out := &in.OtelWatcherConfig, &out.OtelWatcherConfig
		*out = new(OtelWatcherConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OtelWatcherConfig) DeepCopyInto(out *OtelWatcherConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OtelWatcherConfig.
func (in *OtelWatcherConfig) DeepCopy() *OtelWatcherConfig {
	if in == nil {
		return nil
	}
	out := new(OtelWatcherConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TraceFilters) DeepCopyInto(out *TraceFilters) {
	*out = *in
	if in.SpanConditions != nil {
		in, out := &in.SpanConditions, &out.SpanConditions
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
	...
	if in.SpanEventConditions != nil {
		in, out := &in.SpanEventConditions, &out.SpanEventConditions
		*out = new([]string)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TraceFilters.
func (in *TraceFilters) DeepCopy() *TraceFilters {
	if in == nil {
		return nil
	}
	out := new(TraceFilters)
