...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EventMap) DeepCopyInto(out *EventMap) {
	{
		in := &in
		*out = make(EventMap, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventMap.
func (in EventMap) DeepCopy() EventMap {
	if in == nil {
		return nil
	}
	out := new(EventMap)
