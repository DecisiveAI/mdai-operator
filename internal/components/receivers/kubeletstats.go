...
func generateKubeletStatsEnvVars(_ *zap.Logger, config kubeletStatsConfig) ([]corev1.EnvVar, error) {
...
func generateKubeletStatsRbacRules(_ *zap.Logger, config kubeletStatsConfig) ([]rbacv1.PolicyRule, error) {
